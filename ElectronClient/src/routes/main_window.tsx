...
export default function MainWindow() {
    ...
    const [drugs, setDrugs] = useState<{ Gene: string, name: string, score: string }[]>([]);
  ...
  <List>
    {drugs.map((drugs, index) => (
      <ListItem key={index} sx={{flexDirection: "column", alignItems: "flex-start", mb: 2}}>
        ...
        <Typography variant="body2">Indication: {drugs.name}</Typography>
